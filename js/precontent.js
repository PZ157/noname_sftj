		...
		lib.onover.push((result) => {
			...
			for (let i of curs) {
				...
				if (i.storage.sftj && i.name1 !== i.storage.sftj.cg1) {
					if (lib.config.extension_胜负统计_change === 'pre' && i.storage.sftj.cg1 !== undefined)
						names.push(i.storage.sftj.cg1);
				...
				if (i.storage.sftj && i.name2 !== i.storage.sftj.cg2) {
					if (lib.config.extension_胜负统计_change === 'pre' && i.storage.sftj.cg2 !== undefined)
						names.push(i.storage.sftj.cg2);
